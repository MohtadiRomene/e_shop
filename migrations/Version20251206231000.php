...
final class Version20251206231000 extends AbstractMigration
{
    ...
    {
        // Table produit (avec héritage SINGLE_TABLE)
        ...
        // Table promotion_produit (ManyToMany)
        ...
        // Table pannier (sans référence à commande pour l'instant)
        ...
        // Table commande (sans référence à facture pour l'instant)
